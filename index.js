...
function startEditItemTitle() {
    //on button "edit" clicked
        //open new form for changing the item name
}

function cancelEditItemTitle() {
    //on button "cancel" clicked,
        //remove form generated by startEditItemTitle()
}

function submitEditItemTitle() {
    //on button "submit new item title" submitted,
        //update that item's name to input
}
